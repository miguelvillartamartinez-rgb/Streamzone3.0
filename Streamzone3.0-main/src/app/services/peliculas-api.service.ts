...
export class PeliculasApiService {
   ...
   */
  private transformarPelicula(pelicula: PeliculaAPI): PeliculaTransformada {
    return {
      id: pelicula.id,
      nombre: pelicula.title,
      descripcion: pelicula.overview || 'Sin descripción disponible',
      imagen: pelicula.poster_path 
        ? `${this.imageBaseUrl}${pelicula.poster_path}`
        : 'assets/logoStreamZone.png', // Imagen por defecto si no hay poster
      fechaLanzamiento: pelicula.release_date || 'Fecha no disponible',
