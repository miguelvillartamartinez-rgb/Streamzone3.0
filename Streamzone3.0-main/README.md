...
│  │  Login · Registro · Home · Favoritos · Ver más tarde │    │
│  └──────────┬──────────────────────────┬────────────────┘    │
└─────────────┼──────────────────────────┼────────────────────┘
              │ /api/* (proxy)            │ HTTPS
              ▼                           ▼
...
> **Nota:** login y registro requieren una cuenta **Gmail** o **Googlemail** (`@gmail.com` / `@googlemail.com`).
...
- **bcrypt** + **JWT** para autenticación segura (mejora opcional al final del proyecto).
